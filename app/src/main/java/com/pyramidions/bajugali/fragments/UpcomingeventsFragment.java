...
public class UpcomingeventsFragment extends Fragment {
    ...
    private ArrayList<OnGoingDataModel> upcomingDataModelList = new ArrayList<OnGoingDataModel>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        operation();
        onGoingEventAdapter = new OnGoingEventAdapter(context, upcomingDataModelList);
